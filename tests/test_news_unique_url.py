...
if __name__ == '__main__':
    #unittest.main()
    tests = ['bernama', 'borneoPost', 'freeMalaysiaToday', 'ipohEcho', 'malayMail', 'malaysiaChronicle', 'malaysiaKini', 'mySinchew', 'newStraitsTimes', 'selangorku', 'theMalaysianInsider', 'theStar', 'theSunDaily']
    #tests = ['theSunDaily']
